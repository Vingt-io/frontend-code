...
const Footer = () => {
  return (
    <footer className="w-full bg-[#0a0e1a]  py-10 ">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        
        {/* Left - Logo & Name */}
        <div className="flex items-center gap-2">
          <img src={Logo_coloured.src} alt="Vingt.io Logo" className="h-12 w-auto" />
        ...
        <div className="flex gap-4 md:gap-8 text-xs md:text-base font-medium text-gray-300">
          ...
          <Link href="https://vingt-io.gitbook.io/vingt.io/miscellaneous/legal/tokens-restricted-for-restricted-persons" target="_blank" className="hover:text-primaryblue transition">Restricted Persons</Link>
